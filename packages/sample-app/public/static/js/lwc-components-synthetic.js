...
`;
  ...
  */
  ...
  function BaseLightningElementConstructor() {
    ...
    const cmpRoot = vm.lightDom ? elm : renderer.attachShadow(elm, {
      mode,
  ...
  function s(slotName, data, children, slotset) {
    ...
    const vnode = h('slot', data, children); // PHIL: handle Light DOM
  ...
  function getStylesheetsContent(vm, template) {
    ...
    const {
      syntheticShadow
    } = vm.renderer; // PHIL: handle Light DOM
    ...
    if (!isUndefined$1$1(stylesheets) && !isUndefined$1$1(tokens)) {
      ...
      content = evaluateStylesheetsContent(stylesheets, hostSelector, shadowSelector, !(lightDom || syntheticShadow));
    }
  ...
  function useLightDom(def) {
    return !!def.ctor.USE_LIGHTDOM;
  }
  ...
  function createMethodDataCallback(vm, method) {
    return value => {
      ...
      runWithBoundaryProtection(vm, vm.owner, noop$3, () => {
        // job
  ...
  const renderer = {
    ...
    insertGlobalStylesheet(content, element) {
      ...
      const set = doc[styleList] || (doc[styleList] = new Set());
  ...
  function stylesheet$1(hostSelector, shadowSelector, nativeShadow) {
    return ["span.top", shadowSelector, "::after {content: \"(Top Slot)\";}\nspan.bottom", shadowSelector, "::after {content: \"(Bottom Slot)\";}\n"].join('');
  }
  var _implicitStylesheets$1 = [stylesheet$1];

  function stylesheet$2(hostSelector, shadowSelector, nativeShadow) {
    return [".counter", shadowSelector, " {color: blue;}\n"].join('');
  }
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("div", {
      ...
      key: 0
    }, [api_text("Blue Light:")]), api_element("span", {
      classMap: {
        "counter": true
      },
      key: 1
    }, [api_text(" "), api_dynamic($cmp.counter), api_text(" ")]), api_element("button", {
      attrs: {
        "type": "button"
      },
      key: 2,
      on: {
        "click": _m0 || ($ctx._m0 = api_bind($cmp.addOne))
      }
    }, [api_text("Add one")])])];
  }
  ...
  tmpl.stylesheetTokens = {
    hostAttribute: "app-counterBlueLight_counterBlueLight-host",
    shadowAttribute: "app-counterBlueLight_counterBlueLight"
  };

  class Counter extends BaseLightningElement {
    constructor(...args) {
      super(...args);
      this.counter = 0;
    }
  ...
  Counter.USE_LIGHTDOM = true;

  registerDecorators(Counter, {
    fields: ["counter"]
  });

  var _appCounterBlueLight = registerComponent(Counter, {
    tmpl: _tmpl
  });
  ...
  function tmpl$1($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("div", {
      ...
      key: 0
    }, [api_text("Blue Shadow:")]), api_element("span", {
      classMap: {
        "counter": true
      },
      key: 1
  ...
  if (_implicitStylesheets$3) {
    tmpl$1.stylesheets.push.apply(tmpl$1.stylesheets, _implicitStylesheets$3);
  }
  tmpl$1.stylesheetTokens = {
    hostAttribute: "app-counterBlueShadow_counterBlueShadow-host",
    shadowAttribute: "app-counterBlueShadow_counterBlueShadow"
  };

  class Counter$1 extends BaseLightningElement {
    constructor(...args) {
      super(...args);
      this.counter = 0;
    }
  ...
  registerDecorators(Counter$1, {
    fields: ["counter"]
  });

  var _appCounterBlueShadow = registerComponent(Counter$1, {
    tmpl: _tmpl$1
  });

  function stylesheet$4(hostSelector, shadowSelector, nativeShadow) {
    return [".counter", shadowSelector, " {color: red;}\n"].join('');
  }
  ...
  function tmpl$2($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("div", {
      ...
      key: 0
    }, [api_text("Red Light:")]), api_element("span", {
      classMap: {
        "counter": true
      },
      key: 1
  ...
  tmpl$2.stylesheetTokens = {
    hostAttribute: "app-counterRedLight_counterRedLight-host",
    shadowAttribute: "app-counterRedLight_counterRedLight"
  };

  class Counter$2 extends BaseLightningElement {
    constructor(...args) {
      super(...args);
      this.counter = 0;
    }
  ...
  Counter$2.USE_LIGHTDOM = true;

  registerDecorators(Counter$2, {
    fields: ["counter"]
  });

  var _appCounterRedLight = registerComponent(Counter$2, {
    tmpl: _tmpl$2
  });
  ...
  tmpl$3.stylesheetTokens = {
    hostAttribute: "app-counterRedShadow_counterRedShadow-host",
    shadowAttribute: "app-counterRedShadow_counterRedShadow"
  };

  class Counter$3 extends BaseLightningElement {
    constructor(...args) {
      super(...args);
      this.counter = 0;
    }
  ...
  registerDecorators(Counter$3, {
    fields: ["counter"]
  });

  var _appCounterRedShadow = registerComponent(Counter$3, {
    tmpl: _tmpl$3
  });
  ...
  function tmpl$4($api, $cmp, $slotset, $ctx) {
    ...
    return [$cmp.showslots ? api_element("div", {
      key: 2
    }, [api_element("span", {
      classMap: {
        "top": true
      ...
      key: 1
    }, [], $slotset)]) : null, api_element("br", {
      key: 3
    }, []), $cmp.showslots ? api_element("div", {
      key: 6
    }, [api_element("span", {
      classMap: {
        "bottom": true
  ...
  tmpl$4.stylesheetTokens = {
    hostAttribute: "app-containerLight_containerLight-host",
    shadowAttribute: "app-containerLight_containerLight"
  };
  ...
  */
  ...
  tmpl$5.stylesheetTokens = {
    hostAttribute: "app-containerShadow_containerShadow-host",
    shadowAttribute: "app-containerShadow_containerShadow"
  };

  class LayoutShadow extends BaseLightningElement {
    constructor(...args) {
      super(...args);
      this.showslots = isParam('slots');
      this.shownoslots = isParam('no-slots');
  ...
  function tmpl$6($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("h1", {
      ...
      key: 1,
      on: {
        "click": _m0 || ($ctx._m0 = api_bind($cmp.toggleReset))
      }
    }, [api_text("Reset")]), api_element("button", {
      attrs: {
        "type": "button"
      },
      key: 2,
      on: {
        "click": _m1 || ($ctx._m1 = api_bind($cmp.toggleLightContainers))
      }
    }, [api_text("Light Containers")]), api_element("button", {
      attrs: {
        "type": "button"
      },
      key: 3,
      on: {
        "click": _m2 || ($ctx._m2 = api_bind($cmp.toggleShadowContainers))
      }
    }, [api_text("Shadow Containers")]), api_element("button", {
      attrs: {
        "type": "button"
      },
      key: 4,
      on: {
        "click": _m3 || ($ctx._m3 = api_bind($cmp.toggleLightCounters))
      }
    }, [api_text("Light Counters")]), api_element("button", {
      attrs: {
        "type": "button"
      },
      key: 5,
      on: {
        "click": _m4 || ($ctx._m4 = api_bind($cmp.toggleShadowCounters))
      }
    }, [api_text("Shadow Counters")]), api_element("button", {
      attrs: {
        "type": "button"
      },
      key: 6,
      on: {
        "click": _m5 || ($ctx._m5 = api_bind($cmp.toggleSlots))
      }
    }, [api_text("Slots")]), api_element("button", {
      attrs: {
        "type": "button"
      },
      key: 7,
      on: {
        "click": _m6 || ($ctx._m6 = api_bind($cmp.toggleNoSlots))
      }
    }, [api_text("No Slots")]), api_element("table", {
      key: 42
    }, [api_element("tbody", {
      key: 41
    }, [api_element("tr", {
      key: 10
    }, [$cmp.showLightContainer ? api_element("th", {
      key: 8
    }, [api_text("Light Containers")]) : null, $cmp.showShadowContainer ? api_element("th", {
      key: 9
    }, [api_text("Shadow Containers")]) : null]), api_element("tr", {
      key: 25
    }, [$cmp.showLL ? api_element("td", {
      key: 17
    }, [api_element("div", {
      classMap: {
        "counterTitle": true
      ...
      key: 11
    }, [api_text("Light Counters")]), api_custom_element("app-container-light", _appContainerLight, {
      key: 16
    }, [api_element("div", {
      attrs: {
        "slot": "top"
      ...
      key: 13
    }, [api_custom_element("app-counter-blue-light", _appCounterBlueLight, {
      key: 12
    }, [])]), api_element("div", {
      attrs: {
        "slot": "bottom"
      ...
      key: 14
    }, [])])])]) : null, $cmp.showSL ? api_element("td", {
      key: 24
    }, [api_element("div", {
      classMap: {
        "counterTitle": true
      ...
      key: 18
    }, [api_text("Light Counters")]), api_custom_element("app-container-shadow", _appContainerShadow, {
      key: 23
    }, [api_element("div", {
      attrs: {
        "slot": "top"
      ...
      key: 26
    }, [api_text("Shadow Counters")]), api_custom_element("app-container-light", _appContainerLight, {
      key: 31
    }, [api_element("div", {
      attrs: {
        "slot": "top"
      ...
      key: 29
    }, [])])])]) : null, $cmp.showSS ? api_element("td", {
      key: 39
    }, [api_element("div", {
      classMap: {
        "counterTitle": true
      ...
      key: 33
    }, [api_text("Shadow Counters")]), api_custom_element("app-container-shadow", _appContainerShadow, {
      key: 38
    }, [api_element("div", {
      attrs: {
        "slot": "top"
      ...
      key: 43
    }, [api_text("About the Application")]), api_element("div", {
      styleMap: {
        "width": "50em"
      },
      key: 51
      ...
      key: 45
    }, [api_text("Code: "), api_element("a", {
      attrs: {
        "href": "https://github.com/priandsf/lwc/blob/light-dom-1.7.7/packages/sample-app/README.md"
      },
      key: 44
    }, [api_text("https://github.com/priandsf/lwc/blob/light-dom-1.7.7/packages/sample-app/README.md")])]), api_element("p", {
      key: 47
    }, [api_text("This application is made of a light dom component (Main Layout) that renders 4 container components. One the left column, the containers use light dom while the containers on the right columns use shadow dom. "), api_element("br", {
      key: 46
    }, []), api_text("Each container has 2 slots, top and botton, in which are rendered 'Colored Counter' components. The containers also display the 'Colored Counter' components outside of a slot (\"No Slot\"). Similarly the 'Colored Counter' components can use light or shadow dom. This finally shows an hierarchy of light dom and shadow dom components, intermingled.")]), api_element("p", {
      key: 48
    }, [api_text("Use the browser developer tool to inpect the DOM. It shows where the style definitions are injected, whenever it is on the shadow root on the main document head.")]), api_element("p", {
      key: 50
    }, [api_text("The "), api_element("button", {
      attrs: {
        "type": "buttons"
      },
      key: 49
    }, [api_text("buttons")]), api_text(" at the top toggle some of the containers/components. Shwoing less components helps to understand how the style tags are inserted in the DOM.")])]), api_element("img", {
      attrs: {
        "src": "static/images/lightdom.png"
      },
      key: 52
    }, [])];
  }
  ...
  class MainLayout extends BaseLightningElement {
    constructor(...args) {
      super(...args);
      this.showLightContainer = isParam('light-containers');
      this.showShadowContainer = isParam('shadow-containers');
      this.showLightCounter = isParam('light-counters');
      this.showShadowCounter = isParam('shadow-counters');
    }
  ...
  MainLayout.USE_LIGHTDOM = true;

  registerDecorators(MainLayout, {
    fields: ["showLightContainer", "showShadowContainer", "showLightCounter", "showShadowCounter"]
  });
